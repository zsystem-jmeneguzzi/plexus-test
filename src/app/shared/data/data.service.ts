  ...
  public sideBar = [
    {
      ...
      menu: [
        ...
        },
        {
          ...
          subMenus: [
            // {
            //   menuValue: 'Add Carpeta',
            //   route: routes.addCarpeta,
            //   base: routes.addCarpeta,
            //   permision: 'register_carpeta',
            //   show_nav: true,
            // },
            {
              menuValue: 'Lista',
              route: routes.carpetaList,
              base: routes.carpetaList,
              permision: 'carpeta_List',
              show_nav: true,
            },
            {
              menuValue: 'Edit Carpera',
              route: '',
              base: '',
              permision: 'editCarpeta',
              show_nav: false,
            },
            {
              menuValue: 'Delete Carpeta',
              route: '',
              base: '',
              permision: 'delete_carpeta',
              show_nav: false,
            },
            // {
            //   menuValue: 'Patients Profile',
        ...
        {
          menuValue: 'Resumen de Ingresos y Egresos',
          route: routes.incomeExpenseSummary,
          hasSubRoute: false,
          showSubRoute: false,
          icon: 'fa-dollar-sign',
          faIcon: true,
          base: 'income-expense-summary',
          permision: 'income_expense_summary',
          show_nav: true,
          subMenus: [],
        },
        {
